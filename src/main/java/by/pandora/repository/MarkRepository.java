...
public interface MarkRepository extends JpaRepository<Mark, Long> {
    ...
    @Query(value = "select m.userId from Mark as m where m.projectId = :id")
    List<Integer> findMarkUserIdListByProjectId(@Param("id") Long id);
}
